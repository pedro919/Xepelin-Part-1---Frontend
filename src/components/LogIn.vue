      ...
      <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
        <div class="space-y-6">
          ...
          <div>
            ...
            <p v-if="showError" class="text-red mt-2">
              *Usuario o contraseña incorrecto
            </p>
          </div>

          <div>
            <button class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-orange-500 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" @click="login">
              Sign in
            </button>
          </div>
        </div>
